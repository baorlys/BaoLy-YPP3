...
INSERT INTO feedback_group(name) VALUES
  ('Support'),
  ('Report Bug')

INSERT INTO feedback_status(name) VALUES
  ('Open'),
  ('New'),
  ('Solved')

INSERT INTO feedback(user_id,group_id,status_id,content,send_at,sender_email) VALUES 
  (2,1,1,'Can cai thien UI', '12/06/2024 4:29:23','anna@gmail.com'),
  (3,1,2,'UI qua xau', '12/06/2024 4:29:23','qtsc@gmail.com')
...
INSERT INTO feedback_result(feedback_id, content, send_at) VALUES 
  (1,'Dang cai thien','12/06/2024 4:29:23'),
  (2,'Dang cai thien','12/06/2024 4:29:23')

INSERT INTO feedback_result_reply(feedback_result_id, replied_by, replied_at, content) VALUES 
  (1,2,'12/06/2024 4:29:23','Ok'),
  (2,3,'12/06/2024 4:29:23','Duoc roi')
